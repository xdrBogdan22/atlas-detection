package com.example.atlasnaviaidetection.usbcamera;
...
import com.example.atlasnaviaidetection.R;
import com.example.atlasnaviaidetection.sw.TxtOverlay;
import com.example.atlasnaviaidetection.usb.DeviceFilter;
...
import com.example.atlasnaviaidetection.usb.common.UVCCameraHandler;
...
public class UVCCameraHelper {
    ...
    public List<UsbDevice> getUsbDeviceList() {
        List<DeviceFilter> deviceFilters = DeviceFilter
                .getDeviceFilters(mActivity.getApplicationContext(), com.example.atlasnaviaidetection.R.xml.device_filter);
