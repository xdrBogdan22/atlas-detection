...
package com.example.atlasnaviaidetection.usb;
...
//			if (DEBUG) Log.i(TAG, "unregister:");
	 ...
	 * @throws IllegalStateException
	 */
	public List<UsbDevice> getDeviceList(final List<DeviceFilter> filters) throws IllegalStateException, IOException {
		if (destroyed) throw new IllegalStateException("already destroyed");
